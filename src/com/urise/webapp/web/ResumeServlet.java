        ...
        for (SectionType type : SectionType.values()) {
            ...
            if (HtmlUtil.isEmpty(value) && values.length < 2) {
                ...
                switch (type) {
                    case OBJECTIVE:
                    case PERSONAL:
                        r.setSection(type, new SingleLineSection(value));
                        break;
                    case ACHIEVEMENT:
                    case QUALIFICATIONS:
        ...
        switch (action) {
            ...
            case "edit":
                ...
                for (SectionType type : new SectionType[]{SectionType.EXPERIENCE, SectionType.EDUCATION}) {
                    ...
                    emptyFirstOrganizations.add(Organization.Experience.EMPTY);
                    if (section != null) {
                        for (Organization org : section.getExperienceList()) {
                            ...
                            emptyFirstOrganizations.add(new Organization(org.getUrl(), emptyFirstPositions));
                        }
                    }
