...
//
//        RESUME_1.setContact(ContactsType.MAIL, "terminator@gmail.com");
//        RESUME_1.setContact(ContactsType.PHONE, "34444444");
//
//        RESUME_4.setContact(ContactsType.MAIL, "Mail1");
//        RESUME_4.setContact(ContactsType.PHONE, "344444411114");
//    }
    ...
    void update() throws Exception {
        ...
        newResume.setContact(ContactsType.MAIL, "123");
        newResume.setContact(ContactsType.PHONE, "34446666644444");
        newResume.setContact(ContactsType.SKYPE, "Skype");
    ...
    void getAllSorted() throws Exception {
        ...
        Assertions.assertEquals(resumes, Arrays.asList(R1, R2, R3));
